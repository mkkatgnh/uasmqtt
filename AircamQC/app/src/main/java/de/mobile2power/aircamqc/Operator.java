...
public class Operator implements MqttCallback {
	...
	public void setup(String brokerUrl, String clientId) {
		connectorMQTT.setupConnection(brokerUrl, this, clientId);
	}
	...
	public void communicateTaskCaller(long currentTime) throws IOException {
		...
		if (currentTime > (currentTimeMqtt + TIME_5_FPS)) {
	...
	public void connectToBroker(String clientId) {
		connectorMQTT.connect(clientId);
	}
